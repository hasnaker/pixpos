...
// PIXPOS Corporate Logo - New Identity (6x bigger default)
const PixposLogo = ({ width = 480, height = 270 }: { width?: number; height?: number }) => (
  <svg viewBox="0 0 1920 1080" width={width} height={height} fill="white">
    ...
    return (
      <div className="lock-screen-container">
        ...
        <div className="pin-screen">
          <PixposLogo width={360} height={200} />
  ...
  return (
    <div className="lock-screen-container">
      ...
      <div className={`lock-center ${showUserList ? 'hidden' : ''}`}>
        <PixposLogo width={560} height={320} />
      ...
      <div className={`user-panel ${showUserList ? 'visible' : ''}`}>
        <div className="brand">
          <PixposLogo width={240} height={140} />
          <div>
            <h1>PIXPOS</h1>
